...
from content_api.internal.adapters.input.http.base_schemas import PaginationRequest
...
from content_api.internal.adapters.input.http.v1.persons.schemas import (
    PersonDetailResponse,
    PersonFilmResponse,
    PersonListResponse,
    PersonShortResponse,
)
from content_api.internal.core.domain.models.film import Film, SortBy
from content_api.internal.ports.input.films.get_films_by_params_handler import \
    ...
    GetFilmsByParams
from content_api.internal.ports.input.persons.get_person_by_id_handler import \
...
from content_api.internal.ports.input.persons.get_persons_by_search_handler import \
    ...
    SearchPersons
from content_api.internal.ports.input.persons.get_all_persons_handler import \
...
async def person_search(
        ...
        query: str = Query(..., min_length=1)) -> PersonListResponse:
